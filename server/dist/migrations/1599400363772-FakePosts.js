...
exports.FakePosts1599399141974 = void 0;
class FakePosts1599399141974 {
    up(queryRunner) {
...
Suspendisse potenti. In eleifend quam a odio. In hac habitasse platea dictumst.', 19, '2020-01-11T18:16:57Z');
    ...
    down(queryRunner) {
        return __awaiter(this, void 0, void 0, function* () {
            const table = yield queryRunner.getTable('post');
            console.log('TABELELELELLELE', table);
            if (table) {
...
exports.FakePosts1599399141974 = FakePosts1599399141974;
//# sourceMappingURL=1599400363772-FakePosts.js.map